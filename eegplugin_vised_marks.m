...
%    '    EEG=pop_marks_select_data(EEG,''datasize'',size(EEG.data));', ...
%    'else;', ...
%    '    EEG=pop_marks_select_data(EEG,''datasize'',size(EEG.data),''ncomps'',min(size(EEG.icaweights)));', ...
%    'end;'];
cmd='EEG=pop_marks_select_data(EEG);';
