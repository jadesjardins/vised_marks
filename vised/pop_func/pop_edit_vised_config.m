...
%if nargin < 4
    ...
    results=inputgui( ...
        ...
        'evalin(''base'',[''load(fullfile(configFPath,configFName),''''-mat'''');'']);', ...
        PropGridStr]} ... %2
        ...
        'global vcp; vised_config = evalin(''caller'', ''vised_config''); vised_config=propgrid2visedconfig(vcp);' ...
    ...
    %vised_config = evalin('base', 'vised_config');
    vised_config=propgrid2visedconfig(vcp);
